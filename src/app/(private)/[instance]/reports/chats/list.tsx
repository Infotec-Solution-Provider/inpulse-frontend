    ...
    return (
        <div className="mx-auto w-full overflow-y-scroll">
            <table className="w-max text-sm">
                <thead className="bg-indigo-900 rounded-md sticky top-0">
                    <tr>
                        ...
                        <th className="w-32 px-2 py-2 text-left">De</th>
                        <th className="w-32 px-2 py-2 text-left">Até</th>
                        <th className="w-16 px-2 py-2 text-left">Chats</th>
                        <th className="w-28 px-2 py-2 text-left">Mensagens</th>
                        <th className="w-24 px-2 py-2 text-left">Formato</th>
                        <th className="w-16 px-2 py-2 pr-8 text-left">...</th>
                    </tr>
                </thead>

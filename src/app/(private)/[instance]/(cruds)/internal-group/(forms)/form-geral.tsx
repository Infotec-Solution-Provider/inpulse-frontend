...
import { CreateInternalGroupDTO, UpdateInternalGroupDTO, InternalGroupClient, InternalGroupRole } from "@in.pulse-crm/sdk";
import { selectSlotProps, StyledTextField } from "./styles-form";

interface FormGeralProps {
    formData: Partial<InternalGroup>;
    onFormChange: (data: CreateInternalGroupDTO | UpdateInternalGroupDTO) => void;
}
        ...
        <div className="flex flex-col gap-4 w-full">
            ...
            <div className="flex w-full flex-row justify-center gap-4">
                ...
                <StyledTextField
                    ...
                    onChange={(e) => onFormChange({ NIVEL: e.target.value as InternalGroupRole })}
                    slotProps={selectSlotProps}
                >

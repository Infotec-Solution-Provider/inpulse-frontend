...
export type ContactActionRequestStatus = "PENDING" | "APPROVED" | "REJECTED";
export type ContactActionRequestType = "REACTIVATE" | "DELETE";
...
export interface ContactActionRequest {
  ...
  createdAt: string;
  updatedAt: string;
  contact: WppContact & { customer?: Customer | null; sectors?: Array<{ sectorId: number }> };
}

export type ContactActionOutcome =
  | { outcome: "EXECUTED"; contact: WppContact; request?: ContactActionRequest }
  | { outcome: "REQUESTED"; request: ContactActionRequest };

export interface ContactRegistrationConflict {
  code: "CONTACT_ALREADY_EXISTS";
  message: string;
  requiresSupervisorApproval: boolean;
  existingContact: WppContact & {
    customer?: Customer | null;
